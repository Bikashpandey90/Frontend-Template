...
const RibbonLogos = () => {
    return (
        <section className=" py-24 overflow-hidden my-20">
{/* bg-amber-200 */}
            <TranslateWrapper>

                <h2 className="mx-4  text-center text-2xl font-bold text-neutral-900 md:text-[170px] whitespace-nowrap mb-28">
                    WEAR YOUR STORY - PROTECT YOUR PEACE
                </h2>
            </TranslateWrapper>

            <div className="flex translate-y-[50%] rotate-[7deg] scale-110 overflow-hidden border-y-4 border-neutral-900 bg-neutral-50 mt-20">
                <TranslateWrapper>
                    <LogoItemsTop />
                </TranslateWrapper>
                {/* <TranslateWrapper>
